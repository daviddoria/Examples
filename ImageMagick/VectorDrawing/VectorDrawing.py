...
#cmd = "convert car.jpg -fill white -stroke black -draw \"line 0,0 100,30\" output.svg"
cmd = "convert car.jpg -fill white -stroke black -draw \"line 0,0 100,30\" output.png"
os.system(cmd)
