...
int main(int, char *[])
{
  ...
  inputActor->SetInput(castSource->GetOutput());

  vtkSmartPointer<vtkImageActor> xActor =
    vtkSmartPointer<vtkImageActor>::New();
  xActor->SetInput(castXFilter->GetOutput());

  vtkSmartPointer<vtkImageActor> yActor =
    vtkSmartPointer<vtkImageActor>::New();
  yActor->SetInput(castYFilter->GetOutput());

  vtkSmartPointer<vtkImageActor> zActor =
    vtkSmartPointer<vtkImageActor>::New();
  zActor->SetInput(castZFilter->GetOutput());
