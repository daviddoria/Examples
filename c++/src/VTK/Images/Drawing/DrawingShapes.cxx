...
{
  std::cout << "DrawingShapes.cxx" << std::endl;
  ...
  drawing->SetDrawColor(255, 0, 0, 1);
  drawing->DrawCircle(20, 20, 2);

  drawing->SetDrawColor(255, 255, 255, 1);
  drawing->FillBox(5, 10, 5, 10);
