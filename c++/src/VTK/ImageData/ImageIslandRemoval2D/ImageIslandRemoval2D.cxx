...
int main(int, char *[])
{
  ...
  imageSource->FillBox(0, 0, 2, 2);

  // Draw a large box
  imageSource->SetDrawColor(255,255,255);
  imageSource->FillBox(5, 5, 15, 15);
  ...
  islandRemovalFilter->SetIslandValue(255);
  ...
  vtkSmartPointer<vtkImageActor> islandRemovalActor =
    vtkSmartPointer<vtkImageActor>::New();
  islandRemovalActor->SetInput(islandRemovalFilter->GetOutput());
