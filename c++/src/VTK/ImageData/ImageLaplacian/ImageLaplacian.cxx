...
int main(int, char *[])
{
  ...
  castOriginal->SetOutputScalarTypeToUnsignedChar();
  castOriginal->Update();
  ...
  castLaplacian->SetOutputScalarTypeToUnsignedChar();
  ...
  originalActor->SetInput(castOriginal->GetOutput());

  vtkSmartPointer<vtkImageActor> laplacianActor =
    vtkSmartPointer<vtkImageActor>::New();
  laplacianActor->SetInput(castLaplacian->GetOutput());
