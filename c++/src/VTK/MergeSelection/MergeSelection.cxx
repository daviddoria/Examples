...
int main(int, char *[])
{
  ...
  vtkSmartPointer<vtkExtractSelection> extractSelectionCombined =
    vtkSmartPointer<vtkExtractSelection>::New();
  extractSelectionCombined->SetInput(0, pointSource->GetOutput());
