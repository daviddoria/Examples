/*
Phase Correlation is normalized cross correlation in the Fourier domain
http://en.wikipedia.org/wiki/Phase_correlation

Regular cross correlation in the Fourier domain is invFFT(FFT(A) X conj (FFT(B)))
Normalized cross correlation (phase correlation) in the Fourier domain is invFFT( exp (i* [angle(FFT(A))-angle(FFT(B))])
*/
