...
int main(int, char *[] )
{
  ...
  double stepLength = 0.000001; // no matter the value - the "too many samples error outside" error occurs
  optimizer->SetMaximumStepLength( stepLength); // If this is set too high, you will get a
  //"itk::ERROR: MeanSquaresImageToImageMetric(0xa27ce70): Too many samples map outside moving image buffer: 1818 / 10000" error

  optimizer->SetMinimumStepLength( stepLength);
