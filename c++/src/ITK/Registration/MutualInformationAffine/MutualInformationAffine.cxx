...
int main( int argc, char *argv[] )
{
  ...
  const unsigned int numberOfSamples =
                        //static_cast< unsigned int >( numberOfPixels * 0.01 ); // 1% // wild result
                        //static_cast< unsigned int >( numberOfPixels * 0.5 ); // 50% // too slow
                        //static_cast< unsigned int >( numberOfPixels * 0.1 ); // 10%
