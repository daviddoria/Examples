...
int main(int argc, char * argv[])
{
  ...
  SignedMaurerDistanceMapImageFilterType::Pointer signedMaurerDistanceMapImageFilter = SignedMaurerDistanceMapImageFilterType::New();
  signedMaurerDistanceMapImageFilter->SetInput(image);
  signedMaurerDistanceMapImageFilter->Update();

  {
  typedef itk::RescaleIntensityImageFilter< FloatImageType, UnsignedCharImageType > RescaleFilterType;
  RescaleFilterType::Pointer rescaleFilter = RescaleFilterType::New();
  rescaleFilter->SetInput(signedMaurerDistanceMapImageFilter->GetOutput());
  ...
  contourExtractor2DImageFilter->SetInput(signedMaurerDistanceMapImageFilter->GetOutput());
  contourExtractor2DImageFilter->SetContourValue(0);
  contourExtractor2DImageFilter->VertexConnectHighPixelsOff();
  contourExtractor2DImageFilter->ReverseContourOrientationOff();
