...
**
** Created: Sat Dec 3 16:23:03 2011
...
static const char qt_meta_stringdata_Form[] = {
    "Form\0\0on_horizontalSlider_valueChanged(int)\0"
    "SetLabelFromSlider()\0"
};
...
void *Form::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::Form"))
        return static_cast< Ui::Form*>(const_cast< Form*>(this));
...
int Form::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: SetLabelFromSlider(); break;
        default: ;
        }
        _id -= 2;
    }
