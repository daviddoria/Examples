...
int main( int argc, char* argv[])
{
  ...
  /*
  // This doesn't work - the output image is blank
  ...
  */
  ...
  Mat outputImage;
  undistort(Camera1.Image, outputImage, Camera1.CameraMatrix, Camera1.DistortionCoefficients, Camera2.CameraMatrix);
