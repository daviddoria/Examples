...
int main()
{
  ...
  std::set_symmetric_difference(s1.begin(), s1.end(), s2.begin(), s2.end(), inserter(s1butNots2, s1butNots2.begin()));

  std::cout << "s1butNots2 size: " << s1butNots2.size() << std::endl;

  std::set<unsigned int> s2butNots1;
  std::set_symmetric_difference(s2.begin(), s2.end(), s1.begin(), s1.end(), inserter(s2butNots1, s2butNots1.begin()));
